  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        float: '0 8px 32px -8px hsl(var(--foreground) / 0.12), 0 2px 8px -2px hsl(var(--foreground) / 0.08)',
        premium: '0 20px 60px -20px hsl(var(--foreground) / 0.15), 0 8px 24px -8px hsl(var(--foreground) / 0.1)',
